...
countDownDate.setSeconds(countDownDate.getMinutes() + 150); // timestamp
...
die("Connection failed: " . mysqli_connect_error());
        ...
        $hasil=mysqli_query($koneksi, "select * from m_soal WHERE id_ktes='8' ");
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                                    <div class="form-group">
                                      <form name="form2" method="post" action="jawab9.php" id="time">
