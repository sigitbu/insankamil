 ...
 <h1 class="h3 mb-2 text-gray-800">Data</h1>
	<div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <a class="btn btn-primary " href="c_login.php">Cetak</a>
            </div>
            <div class="card-body">
		...
		<tbody>
			<?php 
		include "../koneksi.php";
		$query_mysql = mysqli_query($koneksi,"SELECT * FROM mlogin INNER JOIN m_client USING (id_client) where status = 'aktif' and level= 'user' ")or die(mysqli_error());
		$nomor = 1;
