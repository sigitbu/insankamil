...
<div class="container-fluid">
 <h1 class="h3 mb-2 text-gray-800">Data</h1>
	...
	include "../koneksi.php";
	$id = $_GET['id'];
	$query_mysql = mysqli_query($koneksi,"SELECT * FROM mlogin WHERE id='$id'")or die(mysqli_error());
	$nomor = 1;
		...
		<table>
			<tr>
				...
				<td>
					...
					<!-- <input type="text" class="form-control" name="id_client" value="<?php echo $data['nama'] ?>"> -->
				</td>					
			</tr>	
			<tr>
				<td>Username</td>
